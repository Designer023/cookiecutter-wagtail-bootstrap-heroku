"""
Django settings for {{ cookiecutter.pkg_name }} project.
...
WAGTAIL_SITE_NAME = os.getenv('WAGTAIL_ADMIN_SITE_NAME', 'Wagtail Bootstrapped')
...
BRAND_MODULE = os.getenv('BRAND_MODULE')
